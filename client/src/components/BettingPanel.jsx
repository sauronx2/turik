...
function BettingPanel({ tournamentState, activeBets, username, bottles, onPlaceBet, onRemoveBet }) {
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {myBets.map(([player, userBets]) => (
              <div key={player} className="bg-gray-50 border border-gray-200 p-3 rounded-md flex justify-between items-center">
                <div>
